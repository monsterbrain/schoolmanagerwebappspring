...
/*
    ...
    var bouData = {
      ...
      datasets: [{
        label: 'Current Month',
        fill: 'start',
        data: [2, 4, 8, 10, 4, 8, 4, 7, 9, 2, 4, 5, 8, 3, 4, 5, 1, 4, 7, 8, 4, 2, 0, 0, 0, 0, 0, 0, 0, 0],
        ...
        label: 'Past Month',
        fill: 'start',
        data: [1, 2, 6, 2, 7, 3, 8, 2, 3, 8, 1, 3, 4, 6, 3, 1, 8, 3, 2, 9, 3, 2, 1, 4, 1, 2, 3, 4, 8, 2],
        backgroundColor: 'rgba(255,65,105,0.1)',
    ...
    var ubdData = {
      ...
      labels: ["Maths", "Science", "Art & Literature"]
    };
